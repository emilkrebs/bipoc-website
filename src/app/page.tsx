...
import { getTextData, getTextsData, LocalisationPageProps } from "./lib/texts";
import RenderMarkdown from "./components/markdown";

export async function generateStaticParams() {
	const texts = await getTextsData();
...
export default async function Home({ params }: LocalisationPageProps) {
	const welcomeText = await getTextData("welcome", params.locale);
