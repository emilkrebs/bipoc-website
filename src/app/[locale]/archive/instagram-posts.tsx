...
export default function InstagramPosts() {
    const posts = [
        {
            ...
            link:
        "https://www.instagram.com/reel/C_bMr8OMTl8/?igsh=MXMwbjN4aDljZTRvdw==",
        },
        {
            src: `${imagePath}/call_to_action.webp`,
            alt: "Call to Action",
            link:
        "https://www.instagram.com/p/CzMHEzfsiys/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==",
        },
        {
            src: "/archive/2024/logo.webp",
            alt: "BIPoC Climate Justice Conferece",
            link:
        "https://www.instagram.com/p/CzEugRRMBhH/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==",
        },
        {
            src: `${imagePath}/we_are_back.webp`,
            alt: "We are back!",
            link:
        "https://www.instagram.com/p/C8_8KIXC1bX/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==",
        },
    ];
    ...
    return (
        <section
            id="instagram"
            className="flex flex-wrap items-center justify-center w-full gap-16 lg:gap-28"
        >
...
function Post({ src, alt, link }: { src: string; alt: string; link: string }) {
    return (
        <Link
            href={link}
            target="_blank"
            className="relative w-full rounded-md shadow-2xl cursor-pointer md:w-80"
        >
